...
function switchChartMode(mode, btnEl) {
  ...
  document.querySelectorAll('#tab-inbody .card:nth-of-type(6) .chart-tab-btn').forEach(btn => btn.classList.remove('active'));
...
function renderBodyChart() {
  ...
  const totalWidth = Math.max(container.parentElement.clientWidth, list.length * minWidthPerPoint);
